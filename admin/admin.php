            ...
            <div class="col-md-3" class="text-center">
              <div class="contact-info">
                ...
                <div class="menuAdmin" style="text-align: center;">
                  <span class="btn btn-default" style="background-color:gray; Color:black; text-decoration:none; margin-bottom: 9px; width: 150px;  font-size: 130%;">Compte</span><br>
              ...
              <div class="contact-form">
                <div class="form-group">
                  <div class="col-sm-offset-2 col-sm-10" style="margin-left:1px;">
                    <a href="../CRUD/ajoutClient.php" class="btn btn-default" style="height: 70px; margin-top:100px; width:32%; background-color:#e2725b; Color:white; text-decoration:none;">Ajouter un <br> client</a>
                    <a href="../CRUD/modifClient.php" class="btn btn-default" style="height: 70px; margin-top:100px; width:32%; background-color:#e2725b; Color:white; text-decoration:none;">Modifier un <br> client</a>
                    <a href="../CRUD/supClient.php" class="btn btn-default" style="height: 70px; margin-top:100px; width:32%; background-color:#e2725b; Color:white; text-decoration:none;">Supprimer un <br> client</a>
                  </div>
                </div>
              </div>
            </div>
