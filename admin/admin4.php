            ...
            <div class="col-md-3" class="text-center">
              <div class="contact-info">
                ...
                <div class="menuAdmin" style="text-align: center;">
                  ...
                  <span class="btn btn-default" style="background-color:gray; Color:black; text-decoration:none; margin-bottom: 9px; width: 150px;  font-size: 130%;">Produit</span><br>
              ...
              <div class="contact-form">
                <div class="form-group">
                  <div class="col-sm-offset-2 col-sm-10" style="margin-left:1px;">
                    <a href="../CRUD/ajoutProduit.php" class="btn btn-default" style="height: 85px; margin-top:150px; width:24%; background-color:#e2725b; Color:white; text-decoration:none;">Ajouter un <br> produit</a>
                    <a href="../CRUD/modifProduit.php" class="btn btn-default" style="height: 85px; margin-top:150px; width:24%; background-color:#e2725b; Color:white; text-decoration:none;">Modifier un <br> produit</a>
                    <a href="../CRUD/supProduit.php" class="btn btn-default" style="height: 85px; margin-top:150px; width:24%; background-color:#e2725b; Color:white; text-decoration:none;">Supprimer un <br> produit</a>
                                        <a href="../CRUD/afficherCommande" class="btn btn-default" style="height: 85px; margin-top:150px; width:24%; background-color:#e2725b; Color:white; text-decoration:none;">Afficher les <br> commandes</a>
                  </div>
                </div>
              </div>
            </div>
