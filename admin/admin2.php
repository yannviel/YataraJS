            ...
            <div class="col-md-3" class="text-center">
              <div class="contact-info">
                ...
                <div class="menuAdmin" style="text-align: center;">
                  ...
                  <span class="btn btn-default" style="background-color:gray; Color:black; text-decoration:none; margin-bottom: 9px; width: 150px;  font-size: 130%;">Soin</span><br>
              ...
              <div class="contact-form">
                <div class="form-group">
                  <div class="col-sm-offset-2 col-sm-10" style="margin-left:1px;">
                    <a href="../CRUD/ajoutSoin.php" class="btn btn-default" style="height: 70px; margin-top:100px; width:32%; background-color:#e2725b; Color:white; text-decoration:none;">Ajouter un <br> soin</a>
                    <a href="../CRUD/modifSoin.php" class="btn btn-default" style="height: 70px; margin-top:100px; width:32%; background-color:#e2725b; Color:white; text-decoration:none;">Modifier un <br> soin</a>
                    <a href="../CRUD/supSoin.php" class="btn btn-default" style="height: 70px; margin-top:100px; width:32%; background-color:#e2725b; Color:white; text-decoration:none;">Supprimer un <br> soin</a>
                  </div>
                </div>
              </div>
            </div>
